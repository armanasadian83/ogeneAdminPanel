...
import { editData, fetchDataFromApi, postAuthData } from "../../utils/api";
            ...
            <div className="addAdminSection">
                ...
                <div className="card breadCrumb shadow border-0 mt-1">
                    <div className="d-flex align-items-center py-2 px-4">
                        <h4 className="mx-3">ویرایش ادمین</h4>
                        <div className="me-auto d-flex align-items-center">
                            <div className="hideInMobile">
                                <span><Link to='/'>داشبورد</Link></span>
                                <span>&nbsp; / &nbsp;</span>
                                <span><Link>ویرایش ادمین</Link></span> 
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="card formCard shadow p-4 mt-4 mb-4">
                    <form className="form" onSubmit={editAdmin}>
                        <h4 className='mb-4'>اطلاعات ادمین</h4>
