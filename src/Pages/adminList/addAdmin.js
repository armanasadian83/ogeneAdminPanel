...
const AddAdmin = () => {
    ...
    const addAdmin = (e) => {
        ...
        try {
            ...
            postAuthData("/api/user/signup", formFields).then((res) => {

                if(res.error !== true){
                    context.setAlertBox({
                        open: true,
                        error: false,
                        msg: "ادمین جدید با موفقیت افزوده شد!"
                    });
        ...
        <div className="right-content w-100">
            <div className="addAdminSection">
                ...
                <div className="card formCard shadow p-4 mt-4 mb-4">
                    <form className="form" onSubmit={addAdmin}>
                        <h4 className='mb-4'>ادمین جدید</h4>
