                    ...
                    <div className="table-responsive mt-3">
                        <table className="table table-bordered v-align">
                            ...
                            <tbody>
                                ...
                                {
                                    clientData?.length !== undefined && clientData?.length !== 0 && clientData?.map((client, index) => {
                                       return(
                                           <tr key={index}>
                                               <td>
                                               ...
                                               <td>
                                                   <div className="box text-center">
                                                       {client?.isVerified === true ? 
                                                        <PiSealCheckBold style={{fontSize: '30px', color: 'green'}} /> 
                                                        : <PiSealWarningLight style={{fontSize: '30px', color: 'red'}} />}
                                                   </div>
                                               </td>
                                               <td>
                                                   <div className="box">
